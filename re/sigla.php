...
switch($radio){
case 0;
$con = oci_parse($conn,"SELECT * FROM VWN_DIRECTORIO_COADYUVANTES_PF WHERE SIGLAS='".$sigla."' AND ACRONIMO='".$acronimo."' AND upper(NOMBRE||' '||APELLIDO_PATERNO||' '||APELLIDO_MATERNO||' '||UNIDAD_ORGANIZACIONAL||' '||TIPO_ORGANO_COADYUVANCIA||' '||CAMPO_ESTUDIO||' '||ENTIDAD||' '||CLAVE_CEDULA_AUTORIZACION||' '||CORREO_ELECTRONICO||' '||CURP||' '||RFCPARTICIPANTE)like upper('%".$nombre."%')");
break;
case 1;
$con = oci_parse($conn,"SELECT * FROM VWN_DIRECTORIO_COADYUVANTES_PF WHERE SIGLAS='".$sigla."' AND ACRONIMO='".$acronimo."' AND upper(NOMBRE)like upper('%".$nombre."%')");
break;
case 2;
$con = oci_parse($conn,"SELECT * FROM VWN_DIRECTORIO_COADYUVANTES_PF WHERE SIGLAS='".$sigla."' AND ACRONIMO='".$acronimo."' AND upper(APELLIDO_PATERNO||' '||APELLIDO_MATERNO)like upper('%".$nombre."%')");
break;
case 3;
$con = oci_parse($conn,"SELECT * FROM VWN_DIRECTORIO_COADYUVANTES_PF WHERE SIGLAS='".$sigla."' AND ACRONIMO='".$acronimo."' AND upper(CLAVE_CEDULA_AUTORIZACION)like upper('%".$nombre."%')");
break;
case 4;
$con = oci_parse($conn,"SELECT * FROM VWN_DIRECTORIO_COADYUVANTES_PF WHERE SIGLAS='".$sigla."' AND ACRONIMO='".$acronimo."' AND upper(CORREO_ELECTRONICO)like upper('%".$nombre."%')");
break;
case 5;
$con = oci_parse($conn,"SELECT * FROM VWN_DIRECTORIO_COADYUVANTES_PF WHERE SIGLAS='".$sigla."' AND ACRONIMO='".$acronimo."' AND upper(CURP)like upper('%".$nombre."%')");
break;
case 6;
$con = oci_parse($conn,"SELECT * FROM VWN_DIRECTORIO_COADYUVANTES_PF WHERE SIGLAS='".$sigla."' AND ACRONIMO='".$acronimo."' AND upper(RFCPARTICIPANTE)like upper('%".$nombre."%')");
break;   
}                                    
   oci_execute($con);
   ?>
