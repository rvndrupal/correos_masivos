...
//DESARROLLO   //$dbstr="(DESCRIPTION=(ADDRESS_LIST=(ADDRESS= (PROTOCOL=TCP)(HOST=10.24.22.47)(PORT = 1521)))(CONNECT_DATA=(SID=INT)))";
               //$dbstr="(DESCRIPTION=(ADDRESS_LIST=(ADDRESS= (PROTOCOL=TCP)(HOST=10.24.22.45)(PORT = 1521)))(CONNECT_DATA=(SERVICE_NAME = DES)))";
...
/*/PRODUCCION  */$dbstr="(DESCRIPTION=(ADDRESS_LIST=(ADDRESS= (PROTOCOL=TCP)(HOST=10.24.22.168)(PORT = 1521)))(CONNECT_DATA=(SERVICE_NAME = PROD)))";         
global $conn;
