...
/*DESARROLLO*/   $dbstr="(DESCRIPTION=(ADDRESS_LIST=(ADDRESS= (PROTOCOL=TCP)(HOST=10.24.22.45)(PORT = 1521)))(CONNECT_DATA=(SERVICE_NAME = DES)))";
...
global $conn;
$conn=oci_connect('DIRECTORIO_DTI_APPS','DiR3ct0r1o',$dbstr);
if(!$conn){
$e = oci_error();
